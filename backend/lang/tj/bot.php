...
Тугмаҳои поён низ кор мекунанд.",
    ...
    'report' => [
        'title_today' => '📊 <b>Ҳисоботи имрӯз</b>',
        'title_week' => '📊 <b>Ҳисоботи ҳафта</b>',
        'title_month' => '📊 <b>Ҳисоботи моҳ</b>',
        'when' => '<i>:range</i>',
        'tasks' => '✅ <b>ВАЗИФАҲО</b>',
        'tasks_line' => '<code>:bar</code> :done/:settled · <b>:rate%</b>',
        'tasks_pending' => '⏳ дар интизор: :count',
        'tasks_none' => '<i>Нақша нест</i>',
        'money' => '💰 <b>ПУЛ</b>',
        'money_out' => '🔻 Хароҷот: <b>:amount</b>',
        'money_in' => '🔺 Даромад: <b>:amount</b>',
        'money_none' => '<i>Сабт нест</i>',
        'time' => '⏱ <b>ВАҚТ</b>',
        'time_line' => '<code>:bar</code> <b>:duration</b> · :percent% сабт шуд',
        'time_balance' => '✨ Муфид <b>:good</b> · 🌀 Беҳуда <b>:bad</b>',
        'time_none' => '<i>Сабт нест</i>',
        'top' => 'Бештарин:',
    ],
