...
Тугмаҳои поён низ кор мекунанд.",
    ...
    'act' => [
        'title' => '⏱ <b>Вақт</b>',
        'today' => 'Имрӯз: <b>:duration</b>',
        'week_so_far' => 'Ин ҳафта: <b>:duration</b>',
        'month_so_far' => 'Ин моҳ: <b>:duration</b>',
        'covered' => '<b>:percent%</b>-и шабонарӯз сабт шуд',
        'covered_period' => '<b>:percent%</b>-и давра сабт шуд',
        'average' => 'Ба ҳисоби миёна дар як рӯз: <b>:duration</b>',
        'by_category' => 'Ба чӣ сарф шуд:',
        'saved' => '✅ <b>:duration</b> · :category',
        'saved_uncategorised' => '✅ <b>:duration</b> сабт шуд.',
        'ask_category' => 'Чӣ кор кардед?',
        'pick_for_new' => 'Вақт ба чӣ сарф шуд?',
        'ask_duration' => "<b>:category</b> — чанд вақт?\n\nМасалан: <code>2 соат</code>, <code>45 дақиқа</code> ё <code>1 соат 30 дақ</code>.",
        'how_to_add' => '<i>Бо тугма нависед ё дар як сатр: <code>8 соат хобидам</code></i>',
        'day_title' => '📅 <b>Вақти имрӯз</b>',
        'week_title' => '🗓 <b>Ин ҳафта</b>',
        'month_title' => '📆 <b>:month</b>',
        'empty_day' => 'Имрӯз ҳанӯз вақт сабт нашудааст.',
        'empty_week' => 'Ин ҳафта ҳанӯз вақт сабт нашудааст.',
        'empty_month' => 'Ин моҳ ҳанӯз вақт сабт нашудааст.',
        'recent_title' => '🧾 <b>Сабтҳои охирини вақт</b>',
        'empty_recent' => 'Ҳанӯз сабти вақт нест.',
        'entries' => 'сабтҳо: :count',
        'undone' => '🗑 Нест карда шуд: :duration · :category',
        'nothing_to_undo' => 'Дигар сабти вақт барои нест кардан нест.',
        'learned' => 'Дар ёд гирифтам — минбаъд «:word» :category аст.',
        'targets' => 'Ҳадафҳо:',
        'target_line' => ':category — <b>:spent</b> аз :target',
        'balance' => 'Муфид <b>:good</b> · беҳуда <b>:bad</b>',
        'from_status' => 'аз ҳолат',
        'uncategorised' => 'Бе гурӯҳ',
        'pick_category' => 'Ба кадом машғулият сабт кунам?',
    ],
