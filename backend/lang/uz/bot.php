...
Quyidagi tugmalar ham ishlaydi.",
    ...
    'report' => [
        'title_today' => '📊 <b>Bugungi hisobot</b>',
        'title_week' => '📊 <b>Haftalik hisobot</b>',
        'title_month' => '📊 <b>Oylik hisobot</b>',
        'when' => '<i>:range</i>',
        'tasks' => '✅ <b>VAZIFALAR</b>',
        'tasks_line' => '<code>:bar</code> :done/:settled · <b>:rate%</b>',
        'tasks_pending' => '⏳ :count ta kutilmoqda',
        'tasks_none' => '<i>Reja yo\'q</i>',
        'money' => '💰 <b>PUL</b>',
        'money_out' => '🔻 Chiqim: <b>:amount</b>',
        'money_in' => '🔺 Kirim: <b>:amount</b>',
        'money_none' => '<i>Yozuv yo\'q</i>',
        'time' => '⏱ <b>VAQT</b>',
        'time_line' => '<code>:bar</code> <b>:duration</b> · :percent% yozildi',
        'time_balance' => '✨ Foydali <b>:good</b> · 🌀 Behuda <b>:bad</b>',
        'time_none' => '<i>Yozuv yo\'q</i>',
        'top' => 'Eng ko\'pi:',
    ],
