...
@section('title', '419 · ' . config('app.program_name'))

@section('content')
<div class="min-h-screen w-full flex items-center justify-center relative overflow-hidden" style="background: var(--bg-base);">

    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30rem] h-[30rem] rounded-full blur-[120px] pointer-events-none" style="background: rgba(59, 130, 246, 0.10);"></div>

    <div class="relative z-10 text-center px-4 max-w-lg mx-auto flex flex-col items-center py-20 page-enter">

        <div class="inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-6" style="background: rgba(59, 130, 246, 0.10); border: 1px solid rgba(59, 130, 246, 0.25); color: var(--accent-alt);">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3 w-full sm:w-auto">
            ...
            <a href="{{ url('/') }}" class="btn-secondary w-full sm:w-auto">
