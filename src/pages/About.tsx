    ...
    <div className="pt-16">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="flex items-center space-x-2 text-gray-600 dark:text-gray-400 text-sm">
                  <GraduationCap className="h-4 w-4 text-primary-600 flex-shrink-0" aria-hidden="true" />
              ...
              <div className="relative pb-6 pr-4 sm:pr-6">
                ...
                <div className="absolute bottom-0 right-0 bg-white dark:bg-gray-800 rounded-xl p-3 shadow-lg border border-gray-100 dark:border-gray-700">
                  <div className="flex items-center space-x-2">
                    <Focus className="h-4 w-4 text-primary-500" aria-hidden="true" />
                    <span className="text-xs font-medium text-gray-900 dark:text-white">{t('about.codingPurpose')}</span>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">{t('about.journey')}</h2>
            <p className="mt-4 text-base text-gray-600 dark:text-gray-400">{t('about.journeyDescription')}</p>
          </motion.div>
              ...
              {journey.map((item, index) => (
                ...
                >
                  <div className="flex-1">
                    <Card className={`p-5 ${index % 2 === 0 ? 'mr-6' : 'ml-6'}`}>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{t('about.technicalSkills')}</h2>
              <div className="space-y-4">
                {techStack.map((tech, index) => {
                  const Icon = tech.icon;
                  return (
                    <div key={tech.name} className="flex items-center space-x-4">
                      <Icon className="h-6 w-6 text-primary-600 flex-shrink-0" aria-hidden="true" />
                      <div className="flex-1">
            ...
            <motion.div
              ...
              className="mt-10 lg:mt-0"
            >
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">{t('about.beyondCoding')}</h2>
                ...
                {beyond.map((item, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-start space-x-5">
                      <Icon className="h-6 w-6 text-primary-600 flex-shrink-0 mt-0.5" aria-hidden="true" />
                      <div>
                        <h3 className="font-semibold text-gray-900 dark:text-white text-base">{item.title[lang]}</h3>
                        <p className="text-gray-600 dark:text-gray-400 text-sm">{item.description[lang]}</p>
                      </div>
                    </div>
                  );
                })}
