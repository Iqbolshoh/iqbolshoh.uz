        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                  ...
                  <Card className="overflow-hidden h-full flex flex-col group hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                    <div className="relative overflow-hidden">
                      ...
                      {(project.liveDemo || project.github) && (
                        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-60 transition-all duration-300 flex items-center justify-center space-x-4 opacity-0 group-hover:opacity-100" aria-hidden="true">
                          {project.liveDemo && (
                            <Button
                              size="sm"
          ...
          {filteredProjects.length === 0 && (
            ...
            >
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{t('portfolio.noProjects')}</p>
              <p className="text-gray-500 dark:text-gray-400 mt-2 text-lg">{t('portfolio.tryDifferent')}</p>
            </motion.div>
          )}
        </div>
      </section>
